        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">{{trans('report-receiving.reports')}}
                        - {{trans('report-receiving.receivings_report')}}</div>

                    <div class="panel-body">
                        <div class="well well-sm">{{trans('report-receiving.grand_total')}}
                            : {{DB::table('receiving_items')->sum('total_cost')}}</div>
