                ...
                <div class="row" ng-controller="SearchItemCtrl">
                    ...
                    <div class="col-md-9">
                            ...
                            {!! Form::open(array('url' => 'sales', 'class' => 'form-horizontal')) !!}
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                        {!! Form::select('payment_type', array('Cash' => 'Efectivo', 'Check' => 'Cheque', 'Debit Card' => 'Tarjeta Debito', 'Credit Card' => 'Tarjeta Credito'), Input::old('payment_type'), array('class' => 'form-control')) !!}
                                        </div>
                                    </div>
                                </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <td>@{{newsaletemp.item_id}}</td><td>@{{newsaletemp.item.item_name}}</td><td>@{{newsaletemp.item.selling_price | currency:"Q."}}</td><td><input type="text" style="text-align:center" autocomplete="off" name="quantity" ng-change="updateSaleTemp(newsaletemp)" ng-model="newsaletemp.quantity" size="2"></td><td>@{{newsaletemp.item.selling_price * newsaletemp.quantity | currency:"Q."}}</td><td><button class="btn btn-danger btn-xs" type="button" ng-click="removeSaleTemp(newsaletemp.id)"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></td>
                            </tr>
                        </table>
