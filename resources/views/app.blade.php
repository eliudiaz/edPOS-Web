...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://www.easoftware.net">edPOS</a>
        </div>
                ...
                @if (Auth::check())
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                           aria-expanded="false">{{trans('menu.reports')}} <span class="caret"></span></a>
...
<footer class="footer hidden-print">
    <div class="container">
        <p class="text-muted">You are using <a href="http://www.easoftware.net/">edPos</a> v0.8-alpha by <a
                    href="https://github.com/eliudiaz">EdCracken</a>.
        </p>
    </div>
</footer>
<!-- Scripts -->
<script src="/js/jquery.2.1.3.min.js"></script>
<script src="/js/boostrap.3.3.1.min.js"></script>
<script src="/js/bootstrap-datepicker.min.js"></script>

@yield('javascript-addons')
</body>
</html>
